...
Until this is on the Chrome Web Store, install **0.2.36** from GitHub:

**[Download Other Goats Records 0.2.36](https://github.com/brainswax/othergoat/releases/download/v0.2.36/other-goats-records-0.2.36.zip)**

([0.2.36 release](https://github.com/brainswax/othergoat/releases/tag/v0.2.36) · [All releases](https://github.com/brainswax/othergoat/releases))
